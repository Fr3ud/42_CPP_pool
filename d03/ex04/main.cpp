...
int main( void )
{
	...
	SuperTrap super("5UP3R-TP");

	super.meleeAttack(mike.getName());
	mike.takeDamage(super.getMeleeAtk());

	st2.rangedAttack(super.getName());
	super.takeDamage(st2.getRangedAtk());

	super.rangedAttack(human.getName());
	human.takeDamage(super.getRangedAtk());
	...
	std::cout << leo.getName() << " has " << leo.getHP() << " health left." << std::endl;
	std::cout << mike.getName() << " has " << mike.getHP() << " health left." << std::endl;
	std::cout << super.getName() << " has " << super.getHP() << " health left." << std::endl;
